                        ...
                        <div className="flex flex-col items-end gap-[32px] relative self-stretch w-full flex-[0_0_auto]">
                            <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                                ...
                                <div className="flex flex-col items-start gap-[8px] relative self-stretch w-full flex-[0_0_auto]">
                                    <div className="flex w-[592px] items-center justify-between px-0 py-[4px] relative flex-[0_0_auto] rounded-[8px]">
                                    ...
                                    <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                                        <div className="flex flex-col items-end gap-[8px] relative self-stretch w-full flex-[0_0_auto]">
                                            <div className="relative self-stretch w-full h-[54px]">
                                                <div className="flex w-[592px] items-start justify-between px-[24px] py-[16px] relative rounded-[8px] border border-solid border-[#5a5a5a]">
                                                    <div className="mt-[-1.00px] text-center relative w-fit [font-family:'Aeonik-Medium',Helvetica] font-medium text-[#8f8f8f] text-[18px] tracking-[0] leading-[21.6px] whitespace-nowrap">
                                                        Ox122346684podfjoeu8hfiushfduifhew8heh8faf
                                                    </div>
                                            ...
                                            <div className="inline-flex flex-col items-end relative flex-[0_0_auto] rounded-[8px] border border-solid border-[#5a5a5a]">
                                                <div className="flex w-[592px] items-center justify-between px-[24px] py-[16px] relative flex-[0_0_auto] rounded-[8px] border border-solid border-transparent">
                                                ...
                                                <div className="flex w-[592px] items-center justify-end gap-[10px] px-[24px] py-[16px] relative flex-[0_0_auto] rounded-[8px] border border-solid border-transparent">
                                                    <div className="relative w-[24px] h-[24px]" />
                                                    <div className="inline-flex items-start justify-end relative flex-[0_0_auto]">
                                                        <img
                                                            className="relative w-[24px] h-[24px]"
                                                            alt="Vuesax linear"
                                                            src="/img/vuesax-linear-forward-5-seconds.svg"
                                                        />
                                                        <Label
                                                            className="!flex-[0_0_auto] !pt-[3px] !pb-[7px] !px-[8px] !bg-[unset]"
                                                            labelClassName="!tracking-[-0.32px] !text-[16px] ![font-style:unset] !font-normal ![font-family:'Aeonik-Regular',Helvetica] !leading-[17.9px]"
                                                            status="hover"
                                                            text="Reload"
                                                        />
                                                    </div>
                                        ...
                                        <div className="flex w-[592px] items-center px-0 py-[4px] relative flex-[0_0_auto] rounded-[8px]">
